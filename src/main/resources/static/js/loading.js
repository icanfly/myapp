...
jQuery.fn.showLoading = function(options) {
    ...
    border_left_width = isNaN(parseInt(border_left_width))
        ? 0
        : border_left_width;

    var overlay_left_pos =
        jQuery(this).offset().left + parseInt(border_left_width); // +  $(document.body).css( "border-left" );
    ...
    if (settings.hPos.toString().toLowerCase() == "center") {
        jQuery(loadingDiv).css(
            "left",
            (indicatorLeft +
            (jQuery(overlayDiv).width() - parseInt(jQuery(loadingDiv).width())) /
            2).toString() + "px"
        );
        ...
        jQuery(loadingDiv).css(
            "left",
            (indicatorLeft +
            parseInt(jQuery(overlayDiv).css("margin-left"))).toString() + "px"
        );
    } else if (settings.hPos.toString().toLowerCase() == "right") {
        jQuery(loadingDiv).css(
            "left",
            (indicatorLeft +
            (jQuery(overlayDiv).width() -
            parseInt(jQuery(loadingDiv).width()))).toString() + "px"
        );
    } else {
        jQuery(loadingDiv).css(
            "left",
    ...
    if (settings.vPos.toString().toLowerCase() == "center") {
        jQuery(loadingDiv).css(
            "top",
            (indicatorTop +
            (jQuery(overlayDiv).height() - parseInt(jQuery(loadingDiv).height())) /
            2).toString() + "px"
        );
        ...
        jQuery(loadingDiv).css(
            "top",
            (indicatorTop +
            (jQuery(overlayDiv).height() -
            parseInt(jQuery(loadingDiv).height()))).toString() + "px"
        );
    } else {
        jQuery(loadingDiv).css(
            "top",
...
jQuery.fn.hideLoading = function(options) {
    ...
    jQuery(document.body)
        .find("#loading-indicator-" + indicatorID + "-overlay")
        .remove();
